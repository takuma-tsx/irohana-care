        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left text-gray-700">
            {[
              [
                "共感的に「聴く」人と出会える",
                "あなたの経験や思いを、共感の気持ちで受け止めてくれる相手が見つかります。",
              ],
              [
                "匿名でも安心して話せる",
                "ニックネームでの参加OK。顔出し不要で、気軽にお話しいただけます。",
              ],
              [
                "介護・看取りの経験者が多い",
                "語り手の多くが実体験を持っており、実感をともなった会話ができます。",
              ],
              [
                "初心者でも使いやすい設計",
                "シンプルなUIで、登録から予約までスムーズに進められます。",
              ],
              [
                "利用は1回からでもOK",
                "気が向いたときだけ話すことも可能。定期的な利用も歓迎です。",
              ],
              [
                "管理体制も安心",
                "レビューや通報機能でトラブルを未然に防止。安全にご利用いただけます。",
              ],
            ].map(([title, desc], i) => (
